...
API_ID = int(environ.get('API_ID', '22549633')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '34d8c9887fe445c1dac2228cbdf9ab48')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://graph.org/file/da15e837e0f646db7995e-d05922395aba77f28e.jpg https://graph.org/file/da15e837e0f646db7995e-d05922395aba77f28e.jpg https://graph.org/file/44fbcbc0d97bf6533b97b-67858b6758dfbcf83c.jpg https://graph.org/file/54014f5e349cbda42ec1b-49601352ccde613318.jpg https://graph.org/file/ebcb4805c2dc2dca73d44-046b34a131589916de.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/a1b92cadea104e9c33ad8-72794d06310638ed57.jpg'))
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2057170163 7802198323').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002345888871 -1002346878727 -1001850355982 -1001965696664').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001995831309'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001995831309'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001995831309'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002184377685')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001995831309')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+BteK_SCyV8hhZjM1')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1002224811479')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
AUTH_CHANNELS = [int(channels_id) for channels_id in environ.get('AUTH_CHANNELS', '-1002224811479').split() if re.match(r'^-?\d+$', channels_id)]  # Channels for force sub (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/a1b92cadea104e9c33ad8-72794d06310638ed57.jpg')    # QR code image for payments
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Wamika') # Collection name (default: dreamcinezone_files)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002575608085'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1001995831309')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001995831309')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/How_To_Verify")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/How_To_Verify")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How_To_Verify")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "aae55b0a94d4f309ef5aec38f713a926ea68bc29") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "indiaearnx.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "aae55b0a94d4f309ef5aec38f713a926ea68bc29")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "indiaearnx.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "aae55b0a94d4f309ef5aec38f713a926ea68bc29")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "indiaearnx.com") # Shortener website for third website

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "86000")) # Time gap for two-step verification in seconds (default: 20 minutes)
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "86000"))    
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'auto-filter-bot-jeed.onrender.com'))
...
PING_INTERVAL = int(environ.get("PING_INTERVAL", "3600"))  # 20 minutes
if 'DYNO' in environ:
    ON_HEROKU = True
...
if HAS_SSL:
    URL = "https://auto-filter-bot-jeed.onrender.com/".format(FQDN)
else:
    URL = "https://auto-filter-bot-jeed.onrender.com/".format(FQDN)
